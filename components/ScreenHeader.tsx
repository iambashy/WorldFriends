...
export const ScreenHeader: React.FC<ScreenHeaderProps> = ({
  ...
  const renderRightComponent = () => {
    if (rightComponent === "ellipsis") {
      return (
        <TouchableOpacity style={styles.ellipsisButton} onPress={onRightPress} activeOpacity={0.7}>
          <Ionicons name="ellipsis-horizontal" size={scale(24)} color={theme.colors.text} />
        </TouchableOpacity>
      )
    }
    ...
    if (rightComponent === "button") {
      return (
        <TouchableOpacity
          style={[styles.postButton, rightButtonEnabled ? styles.postButtonEnabled : styles.postButtonDisabled]}
        ...
        >
          <Text
            style={[
              ...
              rightButtonEnabled ? styles.postButtonTextEnabled : styles.postButtonTextDisabled,
            ]}
          >
            {rightButtonText}
          </Text>
  ...
  return (
    <BlurView intensity={80} tint={theme.isDark ? "dark" : "light"} style={styles.container}>
